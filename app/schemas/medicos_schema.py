...
class MedicoBase(BaseModel):
    nro_especialidad: Optional[int]        = Field(..., description="Especialidad principal")
    nro_especialidad2: Optional[int]       = Field(..., description="Especialidad 2")
    nro_especialidad3: Optional[int]       = Field(..., description="Especialidad 3")
    nro_especialidad4: Optional[int]       = Field(..., description="Especialidad 4")
    nro_especialidad5: Optional[int]       = Field(..., description="Especialidad 5")
    nro_especialidad6: Optional[int]       = Field(..., description="Especialidad 6")
    nro_socio: Optional[int]               = Field(..., description="Número de socio")
    nombre: Optional[str]                  = Field(..., description="Nombre completo")
    nombre_: Optional[str]       = Field(None, description="Nombre alternativo")
    apellido: Optional[str]      = Field(None, description="Apellido")
    domicilio_consulta: Optional[str]      = Field(..., description="Domicilio de consulta")
    telefono_consulta: Optional[str]       = Field(..., description="Teléfono de consulta")
    matricula_prov: Optional[int]          = Field(..., description="Matrícula Provincial")
    matricula_nac: Optional[int]           = Field(..., description="Matrícula Nacional")
    ...
    domicilio_particular: Optional[str]    = Field(..., description="Domicilio particular")
    tele_particular: Optional[str]         = Field(..., description="Teléfono particular")
    celular_particular: Optional[str]      = Field(..., description="Celular particular")
    mail_particular: Optional[str]         = Field(..., description="Email particular")
    sexo: Optional[str]                    = Field(..., description="Sexo (M/F)")
    tipo_doc: Optional[str]                = Field(..., description="Tipo de documento")
    documento: Optional[str]               = Field(..., description="Número de documento")
    fecha_nac: Optional[date]    = Field(None, description="Fecha de nacimiento")
    cuit: Optional[str]                    = Field(..., description="CUIT")
    condicion_impositiva: Optional[str] = Field(None, description="Condicion impositiva")
    anssal: Optional[int]                  = Field(..., description="ANS Salud")
    vencimiento_anssal: Optional[date] = Field(None, description="Vencimiento ANSSAL")
    malapraxis: Optional[str]              = Field(..., description="Seguro de mala praxis")
    vencimiento_malapraxis: Optional[date] = Field(None, description="Vencimiento mala praxis")
    monotributista: Optional[str]          = Field(..., description="¿Es monotributista? (SI/NO)")
    factura: Optional[str]                 = Field(..., description="¿Factura? (SI/NO)")
    cobertura: Optional[int]               = Field(..., description="Cobertura")
    vencimiento_cobertura: Optional[date] = Field(None, description="Vencimiento cobertura")
    provincia: Optional[str]               = Field(..., description="Provincia")
    localidad: Optional[str]     = Field(None, description="Localidad")
    codigo_postal: Optional[str]           = Field(..., description="Código postal")
    vitalicio: Optional[str]               = Field(..., description="¿Es vitalicio? (S/N)")
    fecha_vitalicio: Optional[date] = Field(None, description="Fecha de vitalicio")
    observacion: Optional[str]             = Field(..., description="Observaciones")
    categoria: Optional[str]               = Field(..., description="Categoría")
    existe:  Optional[str]            = Field(..., description="¿Existe? (S/N)")
    excep_desde:  Optional[str]            = Field(..., description="Excepción desde (MMYYYY)")
    excep_hasta: Optional[str]            = Field(..., description="Excepción hasta (MMYYYY)")
    excep_desde2: Optional[str]           = Field(..., description="Segunda excepción desde")
    excep_hasta2: Optional[str]           = Field(..., description="Segunda excepción hasta")
    excep_desde3: Optional[str]           = Field(..., description="Tercera excepción desde")
    excep_hasta3: Optional[str]           = Field(..., description="Tercera excepción hasta")
    ingresar:  Optional[str]                = Field(..., description="Campo de control ingreso")
